...
oauth.register(
  name='oidc',
  authority='https://cognito-idp.us-east-2.amazonaws.com/us-east-2_JOlZ2t8ay',
  client_id='3a5ddb3u7qpp1vud8pps87f02n',
  client_secret='<client secret>',
  server_metadata_url='https://cognito-idp.us-east-2.amazonaws.com/us-east-2_JOlZ2t8ay/.well-known/openid-configuration',
